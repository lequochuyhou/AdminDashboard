            ...
            <div class="container-fluid">
                ...
                <div class="_1adminOverveiw_table_recent _box_shadow _border_radious _mar_b30 _p20">
                    ...
                    <Modal
                        ...
                        :closable="false"
                    >
                        <Input v-model="data.tagName" size="large" placeholder="Add tag name"/>
                    ...
                    <Modal
                        ...
                        :closable="false"
                    >
                        <Input v-model="editData.tagName" size="large" placeholder="Edit tag name"/>
        ...
        methods: {
            async addTag() {
                if (this.data.tagName.trim() == '') {
                    return this.e('Tag name is request');
                }
                const res = await this.callApi('post', 'app/create_tag', this.data);
                if (res.status === 201) {
                    this.tags.unshift(res.data);
                    this.s('Tag has been add successfully!');
                    this.addModal = false;
                } else {
                    if(res.status==422){
